...
public:
   ...
   ~FeatureTracker();
    ...
    std::vector<Feature>* GetFeatureVectorPointer(int index) { return &featureSequence_[index]; }
...
private:
    ...
    bool expandEdge(Feature& f, const Vec3i& seed);          // Sub-func inside expandRegion
    void shrinkEdge(Feature& f, const Vec3i& seed);          // Sub-func inside shrinkRegion
